...
3. Name the repository `my_repo`

4. Initialize with a `README.md` file and a `.gitignore`
...
and make a new directory called `GitHub` and navigate into it.
...
look in the In the top right of the new repository there is a green "Code" 
button. Click it and a dialogue will open giving you the option to copy an
address. Use the "HTTPS" option and press the "Copy" button to the right of the
address (2overlapping squares). The address for your repository is now in your
system clipboard. Return to your shell and `git clone` the repository:

```{bash, clone_GitHub, eval=FALSE}
git clone https://github.com/gremau/my_repo.git
```

## Make changes and push to GitHub

Now we will make some changes to our new repository on our local system.
