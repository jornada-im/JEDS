...
# 4. Working collaboratively with GitHub repositories
...
This just tells us we have one remote repository - `origin` - but we can get
more details.
...
## Collaborating on GitHub with "Forking"

You can copy any public repository on GitHub to your own account by "Forking" 
the repository. Essentially, this is creating a clone of the repository for you
in your own account, and that clone will keep contain a link to the original
repository it was forked from. To demonstrate this, lets clone the repository 
that contains this tutorial. Return to GitHub in your browser and follow these
steps.
...
everything as it is and click the <button style="background-color:green;border-color:green;color:white">Create fork</button> button at the bottom.

You'll now have a fork of the repository in your own account, and in the upper
left under the repository name you should see a link back to the original
repository ([jornada-im/JEDS](https://github.com/jornada-im/JEDS)). Now lets
clone this to our local GitHub folder and make some changes.
