...
**NOTE** that you will likely receive additional instructions on packages to
install for your workshop. It is a good idea to install these in advance, using
commands like those above, and let your instructors know if you have any
problems.
...
directory of the GitHub repository. The data files needed for each lesson will
be specified by instructors in advance, or will be provided during the workshop.
You can also check the lesson pages to find information about the data being
used.
...
necessary R packages, installed and up to date. You should receive instructions
in advance about what R packages to install, and other materials you may need
to download. Also, always bring a charger for your device.
